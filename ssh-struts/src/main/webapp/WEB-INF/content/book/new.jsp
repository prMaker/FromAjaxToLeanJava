...
<div class="container">
    ...
    <form action="/book/save" method="post">
        <div  class="form-group">
            <h3>书名：</h3><input type="text" class="form-control" name="book.bookname">
        </div>
        <div class="form-group">
            <h3>价格：</h3><input type="text" class="form-control" name="book.bookprice">
        </div>
        <div class="form-group" >
            <h3>作者：</h3><input type="text" class="form-control" name="book.bookauthor">
        </div>
        <div class="form-group">
            <h3>数量：</h3><input type="text" class="form-control" name="book.booknum">
        </div>
        <div class="form-group">
            <h3>类型：</h3>
