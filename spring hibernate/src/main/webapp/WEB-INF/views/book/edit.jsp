...
<div class="container">
    ...
    <form action="" method="post">
        <div  class="form-group">
            <h3>书名：</h3><input type="text" value="${book.bookname}" class="form-control" name="bookname">
        </div>
        <div class="form-group">
            <h3>价格：</h3><input type="text" value="${book.bookprice}" class="form-control" name="bookprice">
        </div>
        <div class="form-group" >
            <h3>作者：</h3><input type="text" value="${book.bookauthor}" class="form-control" name="bookauthor">
        </div>
        <div class="form-group">
            <h3>数量：</h3><input type="text" value="${book.booknum}" class="form-control" name="booknum">
        </div>
        <div class="form-group">
            <h3>类型：</h3>
